...
// extern "C"
// void dspsv(char* UPLO, int *N, int *NRHS, double *AP,
//            int *IPIV, double *B, int *LDB, int *INFO);
// extern "C"
// void dgbsv(int *N, int* KL, int* KU, int *NRHS, double *AB, int *LDAB,
//            int *IPIV, double *B, int *LDB, int *INFO);
// extern "C"
...
// extern "C"
// void dsptrs(char* UPLO, int* N, int* NRHS, double* AP,
//             int* IPIV, double* B, int* LDB, int* INFO);
//
// // Band
// extern "C"
// void dgbtrf(int* M, int* N, int* KL, int* KU, double* AB,
...
// extern "C"
// void dggev(char* JOBVL, char* JOBVR, int* N, double* A,
