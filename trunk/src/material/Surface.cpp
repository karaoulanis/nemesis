...
const Vector& Surface::get_dfdq(const Vector& s)
{
	myVector.clear();
	return myVector;
}
const Matrix& Surface::get_df2dss(const Vector& s)
{
	this->find_C(s);
	this->find_a(s);
	this->find_da(s);
...
const Matrix& Surface::get_df2dsq(const Vector& s)
{
	myMatrix.clear();
	return myMatrix;
}
const Matrix& Surface::get_df2dqq(const Vector& s)
{
	myMatrix.clear();
	return myMatrix;
}
